...
import { Save, Upload, Image as ImageIcon, ArrowLeft } from "lucide-react"
...
export default function EditFunnel() {
  ...
  const loadFunnel = async () => {
    try {
      const funnelData = await funnelService.getFunnelById(funnelId)
      if (funnelData) {
  ...
  if (loading) {
    return <div className="container mx-auto p-6">Loading funnel...</div>
  }
