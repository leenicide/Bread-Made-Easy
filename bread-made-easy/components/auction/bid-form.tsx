...
export function BidForm({ auction, onBidPlaced, onBuyNow }: BidFormProps) {
  ...
  const currentPrice = Number(auction.current_price) || Number(auction.starting_price)
  ...
  const handleBuyNow = async () => {
    ...
    router.push(`/checkout?auctionId=${auction.id}&type=buy_now&amount=${auction.buy_now}`)
  }
        ...
        {auction.buy_now && (
          <>
            ...
            <div className="text-center space-y-2">
              ...
              <p className="text-xl font-semibold">${auction.buy_now}</p>
